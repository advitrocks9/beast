  ...
  await db.insert(proceduralMemories).values([
    {
      ...
      examples: { good: ["New crop Kenya and a $6 credit"], bad: ["Fresh crop Kenya Karimikui has landed at the roastery"] },
    ...
    },
    {
      ...
      examples: { good: ["$34 sticker, $34 delivered (free over $35)"], bad: ["cheaper than us at $15/bag"] },
    ...
    },
    {
      ...
      examples: { good: ["Maya + the Northwind crew"], bad: ["Best regards, Northwind Support Team"] },
    ...
    },
    {
      ...
      examples: { good: ["Your bag comes off Tuesday's roast and ships Thursday."], bad: ["We'll roast a fresh batch for you tomorrow."] },
      version: 1, isCurrent: true, sourceEpisodes: [dA3],
    ...
    },
    {
      ...
      examples: { good: ["a $6 credit on your next box"], bad: ["15% off your next box"] },
      version: 1, isCurrent: true, sourceEpisodes: [dA1],
    ...
    },
    {
      ...
      examples: { good: ["guest roaster slot on Burnside"], bad: ["Amazing coffee for your cafe!"] },
